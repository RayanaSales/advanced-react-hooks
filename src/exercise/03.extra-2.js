...
// THIS IS AN EXAMPLE DEMONSTRATING HOW TO SHARE STATE WITH DIFFERENT COMPONENTS - USING REACT CONTEXT
...
function usePokemonCache() {
  ...
  if (!context) {
    throw new Error('uePokemonCache must be used in a PokemonCacheProvider')
  }
  return context
}
